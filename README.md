...
The GPS NMEA Emulator is a simple script that emulates a GPS receiver (simulates the unit's movement).
...
When in logging mode (4) is chosen the following dialog appears. Select
the filter by number or enter 0 to disable filtering.
